...
def get_pan(c,rrn,amountt,hst):
    ...
    hst = str(hst)
    if hst == 'Yesforhst':
        c.execute("select aut_prim_acct_numb_f002 from authorization where aut_tran_amou_f004 = \'" + amountt + "\' and aut_retr_ref_numb_f037 = \'" + rrn + "\' union "
                                                                                                                                                             "select aut_prim_acct_numb_f002 from authorization_hst where aut_tran_amou_f004 = \'" + amountt + "\' and aut_retr_ref_numb_f037 = \'" + rrn + "\'")
    else:
        c.execute("select aut_prim_acct_numb_f002 from authorization where aut_tran_amou_f004 = \'" + amountt + "\' and aut_retr_ref_numb_f037 = \'" + rrn + "\'")
    while True:
        row = c.fetchone()
        if row is None:
            pass
...
def get_amount_and_pan(c,rrn,hst):
    ...
    hst = str(hst)
    if hst == 'Yesforhst':
        c.execute("select aut_tran_amou_f004,aut_prim_acct_numb_f002 from authorization where aut_retr_ref_numb_f037 = \'" + rrn + "\' union "
                                                                                                                                   "select aut_tran_amou_f004,aut_prim_acct_numb_f002 from authorization_hst where aut_retr_ref_numb_f037 = \'" + rrn + "\'")
    else:
        c.execute("select aut_tran_amou_f004,aut_prim_acct_numb_f002 from authorization where aut_retr_ref_numb_f037 = \'" + rrn + "\'")
    while True:
        row = c.fetchone()
        if row is None:
            pass
...
def check_authorization(c,rrn,pann,amountt,hst):
    ...
    hst = str(hst)
    if hst == 'Yesforhst':
        c.execute("select aut_retr_ref_numb_f037,aut_resp_code_f039,aut_tran_amou_f004,aut_prim_acct_numb_f002,aut_sour_inte_code,aut_date_time_tran_f012,aut_acq_bank_code from authorization where aut_sour_inte_code = '16' and aut_prim_acct_numb_f002 like \'%" + pann + "\' and aut_tran_amou_f004 = \'" + amountt + "\' and aut_retr_ref_numb_f037 = \'" + rrn + "\' union "
                                                                                                                                                                                                                                                                                                                                                                        "select aut_retr_ref_numb_f037,aut_resp_code_f039,aut_tran_amou_f004,aut_prim_acct_numb_f002,aut_sour_inte_code,aut_date_time_tran_f012,aut_acq_bank_code from authorization_hst where aut_sour_inte_code = '16' and aut_prim_acct_numb_f002 like \'%" + pann + "\' and aut_tran_amou_f004 = \'" + amountt + "\' and aut_retr_ref_numb_f037 = \'" + rrn + "\'")
    else:
        c.execute("select aut_retr_ref_numb_f037,aut_resp_code_f039,aut_tran_amou_f004,aut_prim_acct_numb_f002,aut_sour_inte_code,aut_date_time_tran_f012,aut_acq_bank_code from authorization where aut_sour_inte_code = '16' and aut_prim_acct_numb_f002 like \'%" + pann + "\' and aut_tran_amou_f004 = \'" + amountt + "\' and aut_retr_ref_numb_f037 = \'" + rrn + "\'")
    while True:
        row = c.fetchone()
...
def check_authorization_for_atm(c,rrn,pann,amountt,hst):
    ...
    hst = str(hst)
    if hst == 'Yesforhst':
        c.execute("select aut_retr_ref_numb_f037,aut_resp_code_f039,aut_tran_amou_f004,aut_prim_acct_numb_f002,aut_sour_inte_code,aut_date_time_tran_f012,aut_acq_bank_code from authorization where aut_prim_acct_numb_f002 like \'%" + pann + "\' and aut_tran_amou_f004 = \'" + amountt + "\' and aut_retr_ref_numb_f037 = \'" + rrn + "\' union "
                                                                                                                                                                                                                                                                                                                                          "select aut_retr_ref_numb_f037,aut_resp_code_f039,aut_tran_amou_f004,aut_prim_acct_numb_f002,aut_sour_inte_code,aut_date_time_tran_f012,aut_acq_bank_code from authorization_hst where aut_prim_acct_numb_f002 like \'%" + pann + "\' and aut_tran_amou_f004 = \'" + amountt + "\' and aut_retr_ref_numb_f037 = \'" + rrn + "\'")
    else:
        c.execute("select aut_retr_ref_numb_f037,aut_resp_code_f039,aut_tran_amou_f004,aut_prim_acct_numb_f002,aut_sour_inte_code,aut_date_time_tran_f012,aut_acq_bank_code from authorization where aut_prim_acct_numb_f002 like \'%" + pann + "\' and aut_tran_amou_f004 = \'" + amountt + "\' and aut_retr_ref_numb_f037 = \'" + rrn + "\'")
    while True:
        row = c.fetchone()
        if row is None:
            break
...
def check_pos_transaction(c,rrn,pann,amountt,hst):
    ...
    hst = str(hst)
    if hst == 'Yesforhst':
        c.execute("select aut_retr_ref_numb_f037,aut_resp_code_f039,aut_tran_amou_f004,aut_prim_acct_numb_f002,aut_sour_inte_code,aut_date_time_tran_f012 from authorization where aut_prim_acct_numb_f002 like \'%" + pann + "\' and aut_tran_amou_f004 = \'" + amountt + "\' and aut_retr_ref_numb_f037 = \'" + rrn + "\' union "
                                                                                                                                                                                                                                                                                                                        "select aut_retr_ref_numb_f037,aut_resp_code_f039,aut_tran_amou_f004,aut_prim_acct_numb_f002,aut_sour_inte_code,aut_date_time_tran_f012 from authorization_hst where aut_prim_acct_numb_f002 like \'%" + pann + "\' and aut_tran_amou_f004 = \'" + amountt + "\' and aut_retr_ref_numb_f037 = \'" + rrn + "\'")
    else:
        c.execute("select aut_retr_ref_numb_f037,aut_resp_code_f039,aut_tran_amou_f004,aut_prim_acct_numb_f002,aut_sour_inte_code,aut_date_time_tran_f012 from authorization where aut_prim_acct_numb_f002 like \'%" + pann + "\' and aut_tran_amou_f004 = \'" + amountt + "\' and aut_retr_ref_numb_f037 = \'" + rrn + "\'")
    while True:
        row = c.fetchone()
        if row is None:
            break
...
def check_amount(c,rrn,pann,hst):
    ...
    hst = str(hst)
    if hst == 'Yesforhst':
        c.execute("select aut_retr_ref_numb_f037,aut_resp_code_f039,aut_tran_amou_f004,aut_prim_acct_numb_f002,aut_sour_inte_code,aut_date_time_tran_f012 from authorization where aut_prim_acct_numb_f002 like \'%" + pann + "\' and aut_retr_ref_numb_f037 = \'" + rrn + "\' union "
                                                                                                                                                                                                                                                                           "select aut_retr_ref_numb_f037,aut_resp_code_f039,aut_tran_amou_f004,aut_prim_acct_numb_f002,aut_sour_inte_code,aut_date_time_tran_f012 from authorization_hst where aut_prim_acct_numb_f002 like \'%" + pann + "\' and aut_retr_ref_numb_f037 = \'" + rrn + "\'")
    else:
        c.execute("select aut_retr_ref_numb_f037,aut_resp_code_f039,aut_tran_amou_f004,aut_prim_acct_numb_f002,aut_sour_inte_code,aut_date_time_tran_f012 from authorization where aut_prim_acct_numb_f002 like \'%" + pann + "\' and aut_retr_ref_numb_f037 = \'" + rrn + "\'")
    while True:
        row = c.fetchone()
        if row is None:
            break
